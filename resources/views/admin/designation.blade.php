...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Admin Designation')</title>
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a class='activated' href='#'>Designation</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="coupon_form" action="{{route('addDesignation')}}" method="POST" class="form-horizontal">
                                            @csrf
                                            <div class="form-body">
                                ...
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('deleteDesignation', $designation->uuid) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this designation?');">
                                                    @csrf
                                                    @method('DELETE')
