                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row" style="padding: 20px;">
                            <div class="col-md-12">
                                <form id="course_form" action="/gym-staff" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="member_name" type="text" name="member_name" required class="form-control" placeholder="Enter Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
