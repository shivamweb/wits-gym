...
<aside class="right-side right-padding">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Gym Staff</li>
        </ol>
    </section>
    <!--section ends-->
                                        ...
                                        <div class="col-md-7 text-center">
                                            <div class="input-group">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    ...
                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                        <img src="{{ asset('placeholder-image.jpg') }}" alt="profile">
                                                    </div>
                                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                ...
                                                <input id="member_name" @if ($staffDetail && $staffDetail->name) value="{{ $staffDetail->name }}" @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                ...
                                                <input id="salary" @if ($staffDetail && $staffDetail->salary) value="{{ $staffDetail->salary }}" @endif
                                                    type="number" required name="salary" class="form-control"
                                                    placeholder="Enter Salary">
                                                <input type="hidden" name="uuid" id="uuid" @if ($staffDetail && $staffDetail->uuid) value="{{ $staffDetail->uuid }}" @endif>
                                            </div>
                                        </div>
                                    </div>
