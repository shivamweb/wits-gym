            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row" style="padding: 20px;">
                            <div class="col-md-12">
                                <form id="course_form" action="/gym-coupon" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="amount" step="any" type="number" required name="amount" class="form-control" placeholder="Enter Amount">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="discount" step="any" type="number" required name="discount" class="form-control" placeholder="Enter Discount">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="max_amount" type="number" name="max_amount" required class="form-control" placeholder="Enter Maximum Amount">
                                                </div>
                                            </div>
                                        </div>
