            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-group">
                            <li class="m10 active">
                                <a href="#faq1" data-toggle="tab" class="list-group-item">
                                Yoga
                                <i class="fa fa-fw fa-chevron-right mrg"></i>
                            </a>
                            </li>
                            <li class="m10">
                                <a href="#faq2" data-toggle="tab" class="list-group-item">
                                Fitness
                                <i class="fa fa-fw fa-chevron-right mrg"></i>
                            </a>
                            </li>
                            <li class="m10">
                                <a href="#faq3" data-toggle="tab" class="list-group-item">
                                Aerobics
                                <i class="fa fa-fw fa-chevron-right mrg"></i>
                            </a>
                            </li>
                            <li class="m10">
                                <a href="#faq4" data-toggle="tab" class="list-group-item">
                                Body Building
                                <i class="fa fa-fw fa-chevron-right mrg"></i>
                            </a>
                            </li>
                            <li class="m10">
                                <a href="#faq5" data-toggle="tab" class="list-group-item">
                                Flexibility
                                <i class="fa fa-fw fa-chevron-right mrg"></i>
                            </a>
                            </li>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <div class="tab-pane fade active in " id="faq1">
                                <div class="panel-group" id="accordion5">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    The Indian sage Patanjali is believed to have collated the practice of Yoga into the Yoga Sutra an estimated 2,000 years ago.</p>
                                                <p>The Sutra is a collection of 195 statements that serves as a philosophical guidebook for most of the Yoga that is practiced today. It also outlines eight limbs of yoga: the yamas (restraints), niyamas (observances), asana (postures), pranayama (breathing), pratyahara (withdrawal of senses), dharana (concentration), dhyani (meditation), and samadhi (absorption).
                                                </p>
                                                <p>As we explore these eight limbs, we begin by refining our behavior in the outer world, and then we focus inwardly until we reach samadhi (liberation, enlightenment).
                                                </p>
                                                <p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    There is debate about this in the Yoga community—I believe that it is a personal decision that everyone has to make for themselves.</p>
                                                <p>If you are considering becoming a vegetarian, be sure to take into account your personal health issues as well how your choices will affect those with whom you live.</p>
                                                <p>Being a vegetarian should not be something that you impose on others—that kind of aggressive action in itself is not an expression of ahimsa.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    Yoga is amazing—even if you only practice for one hour a week, you will experience the benefits of the practice.</p>
                                                <p>If you can do more than that, you will certainly experience more benefits. I suggest starting with two or three times a week, for an hour or an hour and a half each time.
                                                </p>
                                                <p>
                                ...
                                <div class="panel-group" id="accordion1">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne1" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    The ability to gain muscle while losing fat is dependent on the relationship between your fatness and muscularity. </p>
                                                <p>An overly-fat and under-trained person will be able to achieve simultaneous fat loss and muscle gain.</p>
                                                <p>A very lean person near his/her limit for muscle growth will not. As one moves away from the overly-fat, under-trained status towards a leaner, more muscular body this ability is diminished.</p>
                                                <p>At some point, the vast majority of people will see better/quicker results by choosing to do one or the other (gain muscle, lose fat - often referred to as 'bulking' and 'cutting', respectively) at a time.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseThree1" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    The best thing you can do is to stop thinking that "motivation" is going to be what gets you results. </p>
                                                <p>Trying to sustain going to the gym or changing your diet with motivation is like trying to warm your house with a firecracker. </p>
                                                <p>It'll give you a short burst of energy and then nothing. Motivation is something you use to push through that last rep you're struggling with, not for sticking with a new practice. Thinking of this in terms of motivation is why you have failed in the past.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-group" id="accordion2">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne2" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    Step aerobics is a form of aerobic activity which is performed on a platform that usually ranges from 4" to 10" in height. Step training was developed to provide a low-impact activity that is both challenging and interesting. </p>
                                                <p>People who may not like certain aspects of aerobic dance find that step is a very good alternative. Each participant works within his or her own space. There is no traveling across a room. When done properly, step training is an efficient means of improving aerobic fitness.
                                                </p>
                                                <p>
                            ...
                            <div class="tab-pane fade" id="faq4">
                                <div class="panel-group" id="accordion3">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne4">
                                                <h4 class="panel-title">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#accordion3" href="#collapseTwo4">
                                                <h4 class="panel-title">
                            ...
                            <div class="tab-pane fade" id="faq5">
                                <div class="panel-group" id="accordion4">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#accordion4" href="#collapseOne5">
                                                <h4 class="panel-title">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#accordion4" href="#collapseTwo5">
                                                <h4 class="panel-title">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#accordion4" href="#collapseThree5">
                                                <h4 class="panel-title">
