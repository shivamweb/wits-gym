                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="users">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder="enter username" id="fb-name"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder="enter email" id="fb-name"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            value="{{ $userDetail->gender }}" required
                                                                            placeholder="enter user Gender" id="fb-name"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            value="{{ $userDetail->phone_no }}" required
                                                                            placeholder="enter phone number"
                                                                            id="fb-name" name="phone_no"
                                                                            class="form-control">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            value="{{ $userDetail->password }}" required
                                                                            placeholder="enter password" id="fb-name"
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="workout">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <form action="{{ route('addUserWorkout') }}" method="POST"
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-lg-2 control-label"
                                                                for="exercise_name">Exercise Name:</label>
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    <input type="text" name="exercise_name"
                                                                        id="exercise_name" required class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="diet">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <form action="{{ route('addUserDiet') }}" method="POST"
                                                    class="form-horizontal" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="user_id" value="{{ $userDetail->id }}">
                                                    <div class="form-group">
