                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="subscription_duration" type="text" name="validity"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="subscription_price" type="text" name="amount"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="subscription_id" type="text" name="plan_id"
