                            ...
                            <div class="col-md-12">
                                <form id="course_form" action="/gym-subscription" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Image <span class='require'>*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_name" type="text" required name="subscription_name" class="form-control" placeholder="Enter Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_duration" type="text" name="validity" required class="form-control" placeholder="Enter Subscription Duration">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="start_date" type="date" name="start_date" required class="form-control" placeholder="Enter Start Date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_price" type="text" name="amount" required class="form-control" placeholder="Enter Course Price">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <table class="table table-bordered" id="fitness-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('deleteSubscription', $subscription->uuid) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this subscription?');">
                                            @csrf
                                            @method('DELETE')
