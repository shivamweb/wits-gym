                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_name" value={{$subscription->subscription_name}} type="text" required name="subscription_name" class="form-control" placeholder="Enter Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_duration" value={{$subscription->validity}} type="text" name="validity" required class="form-control" placeholder="Enter Subscription Duration">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="start_date" value={{$subscription->start_date}} type="date" name="start_date" required class="form-control" placeholder="Enter Start Date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input id="subscription_price" value={{$subscription->amount}} type="text" name="amount" required class="form-control" placeholder="Enter Course Price">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
